...
import { containsFilterState, filterUsers, listUserFilterState } from '@/States/ListUserState/listUserState';
    ...
    <>
      ...
      >
        ...
        <Grid container
          ...
          justifyContent="center"
        >
          <Button onClick={() => router.push('/formcreateuser')} variant="contained">Crear Usuario</Button>
        </Grid>
        <Box >
          <DataGrid columns={columns} rows={listFilterUsers}
            pageSizeOptions={[4]}
            initialState={{
              pagination: {
                paginationModel: {
      ...
      >
        ...
        <FormControl>
          ...
          <TextField value={contains} required onChange={(e) => setContains(e.target.value)} ></TextField>
        </FormControl>
